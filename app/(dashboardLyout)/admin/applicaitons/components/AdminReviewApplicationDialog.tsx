...
interface AdminReviewApplicationDialogProps {
...
export default function AdminReviewApplicationDialog({
  application,
  isOpen,
  onClose,
  onSuccess,
}: AdminReviewApplicationDialogProps) {
  const [reviewApplication, { isLoading }] =
    useAdminReviewApplicationMutation();
